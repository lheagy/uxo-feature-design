...
src2 = MagneticControlledSource(receiver_list=[receivers], location=np.c_[x_nodes + offset[0], y_nodes + offset[1], z_nodes + offset[2]], current=100)
...
x0=np.random.rand(mesh.n_cells*3)
def deriv_test(x):
